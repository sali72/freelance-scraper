...
class KarlancerScraper :
    ...
    def crawl(self):
        ...
        while True:
            get_projects_info()
            page_counter += 1
            reload_ref = driver.find_element(By.XPATH, reload_reference_xpath)
            # check if there is another page
            if len(driver.find_elements(By.ID, 'navigatePage_next')) == 0:
                break
            # go to next page
            ...
            new_reload_ref = driver.find_element(By.XPATH, reload_reference_xpath)
